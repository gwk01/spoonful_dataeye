...
with col3:
    ...
    fig.update_layout (title_text = 'Lebanese Districts Poverty Predictions in 2022 <br> by Deploying Satellite Imagery Data on Random Forest Regressor', title_x = 0.5,plot_bgcolor='Light Grey', showlegend=False,
